...
// document.body.children[2].textContent = thisArray[randomIndex]

var generate = function () {
  var randomIndex = Math.floor(Math.random() * thisArray.length)
  var divIamLookingFor = document.querySelector('div')
  divIamLookingFor.textContent = thisArray[randomIndex]
}

var button = document.querySelector('button') // first find the button and put it into a variable
